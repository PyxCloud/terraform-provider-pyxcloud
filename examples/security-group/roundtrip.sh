...
: > oracle/generated.tf
"$RENDER_BIN" -fixture "../security-group/sg.json" -provider oracle -component network >> oracle/generated.tf
echo "" >> oracle/generated.tf
"$RENDER_BIN" -fixture "../security-group/sg.json" -provider oracle -component security-group >> oracle/generated.tf
echo "" >> oracle/generated.tf
