...
: > oracle/generated.tf
"$RENDER_BIN" -fixture "../managed-database/db-oracle.json" -provider oracle -component network >> oracle/generated.tf
echo "" >> oracle/generated.tf
"$RENDER_BIN" -fixture "../managed-database/db-oracle.json" -provider oracle -component security-group >> oracle/generated.tf
echo "" >> oracle/generated.tf
"$RENDER_BIN" -fixture "../managed-database/db-oracle.json" -provider oracle -component managed-database >> oracle/generated.tf
echo "" >> oracle/generated.tf
