...
: > oracle/generated.tf
"$RENDER_BIN" -fixture "../object-storage/storage.json" -provider oracle -component network >> oracle/generated.tf
echo "" >> oracle/generated.tf
"$RENDER_BIN" -fixture "../object-storage/storage.json" -provider oracle -component object-storage >> oracle/generated.tf
echo "" >> oracle/generated.tf
